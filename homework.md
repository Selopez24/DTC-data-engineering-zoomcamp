...
In Docker Compose, services can communicate using their service names as hostnames. The `db` service exposes port 5432 internally, so pgadmin connects to `db:5432`.
